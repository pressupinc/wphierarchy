	...
	<body>
		<div class="container">
			...
			<div class="main clearfix">
				...
				<div class="creds">
				<div class="notice" style="background: red; color: white; padding: .5rem; font-weight: bold; display: block;">
					Please note: This version of the wphierarchy.com site is no longer supported.
				</div>
